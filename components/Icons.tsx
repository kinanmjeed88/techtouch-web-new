...
export const TelegramIcon: React.FC = () => (
  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path d="M15.343 13.913l-3.328 3.328a.999.999 0 01-1.414 0l-3.328-3.328a.999.999 0 111.414-1.414l1.621 1.621V4a1 1 0 112 0v10.121l1.621-1.621a.999.999 0 111.414 1.414zM21.191 2.809a2.955 2.955 0 00-4.179 0L2.809 17.012a2.955 2.955 0 000 4.179l-1.007 1.007a1 1 0 001.414 1.414l1.007-1.007a2.955 2.955 0 004.179 0L22.605 8.404a2.955 2.955 0 000-4.179l-1.414-1.416zM4.93 18.427a.955.955 0 010-1.35l12.83-12.83a.955.955 0 011.35 0l1.414 1.414a.955.955 0 010 1.35L7.7 21.171a.955.955 0 01-1.35 0l-1.42-1.42z"/>
  </svg>
);
